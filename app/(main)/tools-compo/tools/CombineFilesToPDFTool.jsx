...
export default function CombineFilesToPDFTool() {
  ...
  return (
    <ToolPageShell widthClassName="max-w-7xl px-2 pt-20 pb-10">
      <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white/85 px-3 py-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur dark:border-slate-700/50 dark:bg-slate-800/50 dark:shadow-[0_20px_60px_rgba(0,0,0,0.3)] sm:px-6 ">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.55fr_0.95fr]">
            <div className="space-y-6">
              ...
              >
                ...
                >
                  <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-amber-100 text-sm font-semibold text-amber-800 dark:bg-amber-900/30 dark:text-amber-300">
                    FILE
                  </div>
                ...
                <div className="mt-4 space-y-3">
                  {queue.length ? (
                    queue.map((item, index) => (
                      <div
                        key={item.id}
                        className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700/50 dark:bg-slate-800/30"
                      >
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                          <div>
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <span className="rounded-full bg-white px-2 py-0.5 text-[11px] font-semibold text-slate-500 dark:bg-slate-700 dark:text-slate-400">
                          ...
                          <div className="flex flex-wrap gap-2">
                            <button
                              ...
                              disabled={index === 0}
                              className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700/50 dark:bg-slate-800/50 dark:text-slate-300 dark:hover:border-slate-600 dark:hover:bg-slate-700/50"
                            >
                              Up
                            </button>
                            <button
                            ...
                            <button
                              ...
                              className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-100 dark:border-slate-700/50 dark:bg-slate-800/50 dark:text-slate-300 dark:hover:border-slate-600 dark:hover:bg-slate-700/50"
                            >
                              Remove
                            </button>
                          </div>
            ...
            <aside className="space-y-6">
                ...
                {downloadUrl ? (
                  <div className="mt-5 space-y-3">
                    ...
                    <p className="text-xs leading-5 text-slate-500 dark:text-slate-400">
                      The combined PDF is saved locally in your browser until
                      you refresh or clear the tool.
                    </p>
                  </div>
                ) : null}
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-5 shadow-sm dark:border-slate-700/50 dark:from-slate-800/50 dark:to-slate-800/30">
                ...
                <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600 dark:text-slate-400">
                  ...
                  <li>
                    - Images and SVG files become visible pages in the PDF.
                  </li>
