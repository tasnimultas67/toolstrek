...
export default function CompressPDFTool() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-amber-50/60 px-2 pb-10 pt-26 shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
