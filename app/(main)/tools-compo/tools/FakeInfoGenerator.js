...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
  ...
  return (
    <ToolPageShell widthClassName="max-w-7xl pt-24 pb-10">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-1/3">
              <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-md p-6 sticky top-20 border border-gray-200 dark:border-neutral-700">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-slate-300 dark:border-neutral-600 rounded-lg py-2.5 px-4 text-slate-700 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white dark:bg-neutral-800 cursor-pointer"
                    >
                  ...
                  {!isLoading && generatedData.length > 0 && !error && (
                    <div className="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 rounded-lg">
                      <p className="text-green-700 dark:text-green-400 text-sm flex items-center justify-center gap-1">
            ...
            <div className="lg:w-2/3">
              ...
              {isLoading ? (
                <div className="flex flex-col items-center justify-center h-96 bg-white dark:bg-neutral-900 rounded-xl shadow-md border border-gray-200 dark:border-neutral-700">
                ...
                <div className="space-y-4">
                  {/* Result count header */}
                  <div className="bg-white dark:bg-neutral-900 rounded-lg p-3 shadow-sm border border-slate-200 dark:border-neutral-700">
                  ...
                  {generatedData.map((person, idx) => (
                    <div
                      key={person.id}
                      className="bg-white dark:bg-neutral-900 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-200 border border-slate-100 dark:border-neutral-700"
                    >
                      {/* Card Header with Gender Badge */}
                      <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 dark:from-indigo-700 dark:to-indigo-800 px-5 py-3 flex justify-between items-center">
                      ...
                      <div className="p-5">
                        <div className="flex gap-4">
                          ...
                          <img
                            src={person.avatar}
                            alt={person.fullName}
                            className="w-20 h-20 rounded-full border-2 border-indigo-200 dark:border-indigo-700 object-cover"
                          />
                          ...
                          <div className="flex-1 space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-sm">
                              <div>
                                ...
                                <p className="text-slate-700 dark:text-gray-300 break-all">
                                  {person.email}
                                </p>
                              </div>
                              <div>
          ...
          {/* Footer Disclaimer */}
          <div className="mt-10 text-center text-sm text-slate-400 dark:text-slate-500 border-t border-slate-200 dark:border-neutral-700 pt-6">
            <p>
              ⚠️ All data is fetched in real-time from randomuser.me API - No
              data is stored or cached
            </p>
            <p className="text-xs mt-1">
              Each request generates completely new, fresh data from the
              internet | Bangladesh 🇧🇩 support included
            </p>
          </div>
        </div>
