    ...
    <ToolPageShell widthClassName="max-w-6xl">
      <div className="font-sans">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/30 overflow-hidden border border-gray-100 dark:border-gray-700">
          {/* Header */}
          <div className="bg-gradient-to-r from-teal-500 to-blue-600 dark:from-teal-600 dark:to-blue-700 px-6 py-8 sm:px-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
              BMI Calculator
            </h1>
            <p className="text-teal-100 dark:text-teal-200 mt-2 text-base sm:text-lg">
          ...
          <div className="p-6 sm:p-8">
                ...
                <div className="flex bg-gray-100 dark:bg-gray-700 rounded-xl p-1 w-full sm:w-auto">
                  <button
                    ...
                    className={`flex-1 px-5 py-2.5 rounded-lg font-medium transition-all duration-200 ${
                      unitSystem === "metric"
                        ? "bg-white dark:bg-gray-600 text-teal-600 dark:text-teal-400 shadow-sm ring-1 ring-teal-200 dark:ring-teal-700"
            ...
            <div className="mb-8">
              <h2 className="text-gray-800 dark:text-gray-200 font-semibold mb-4 flex items-center gap-2">
                <svg
              ...
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      className={`flex-1 py-3 px-4 rounded-xl font-medium transition-all duration-200 flex items-center justify-center gap-2 ${
                        gender === "female"
                          ? "bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 border-2 border-teal-300 dark:border-teal-600"
                          : "bg-gray-50 dark:bg-gray-700/50 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600"
                      }`}
                    >
                      <svg
                        className="w-5 h-5"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-teal-500 dark:focus:ring-teal-400 focus:border-transparent outline-none transition-all text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 mb-8">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-teal-600 to-blue-600 dark:from-teal-500 dark:to-blue-500 hover:from-teal-700 hover:to-blue-700 dark:hover:from-teal-600 dark:hover:to-blue-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg dark:shadow-gray-900/30"
              >
                Calculate BMI
              </button>
              <button
                onClick={resetForm}
                className="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200"
              >
                Reset
              </button>
            </div>
            ...
            {bmiResult !== null && (
              <div className="border-t border-gray-100 dark:border-gray-700 pt-8 animate-fadeIn">
                <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800/50 dark:to-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm dark:shadow-gray-900/20">
                  <div className="grid lg:grid-cols-2 gap-6">
                    ...
                    <div className="text-center lg:text-left">
                      ...
                      <div className="text-6xl font-bold text-gray-800 dark:text-gray-100 mt-2">
                        {bmiResult}
                      </div>
                      ...
                      <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        ...
                        <p className="text-base font-semibold text-blue-900 dark:text-blue-200">
                          18.5 - 24.9
                          {parseInt(age) >= 65 && (
                            <span className="text-sm font-normal text-blue-700 dark:text-blue-400 block mt-1">
                    ...
                    <div>
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-5 border border-blue-100 dark:border-blue-800/50 h-full">
                        <div className="flex gap-3">
                          ...
                          <div>
                            <p className="text-gray-700 dark:text-gray-300 leading-relaxed font-medium mb-1">
                              Health Insight
                            </p>
                  ...
                  <div className="mt-8">
                    <div className="relative h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                      ...
                      ></div>
                      <div
                        className="absolute w-0.5 h-4 bg-gray-700 dark:bg-gray-300 top-1/2 -translate-y-1/2"
                      ...
                      {showTips && (
                        <div className="space-y-4 animate-fadeIn">
                          {personalizedTips.map((tipSection, index) => (
                            <div
                              key={index}
                              className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm hover:shadow-md dark:hover:shadow-gray-900/30 transition-shadow"
                            >
                  ...
                  {/* Age-specific Note */}
                  {age && parseInt(age) >= 65 && (
                    <div className="mt-5 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-100 dark:border-amber-800/50">
                      <p className="text-xs text-amber-800 dark:text-amber-300">
                        ℹ️ For adults 65+, a slightly higher BMI (23-27) is
                        often associated with better health outcomes and
                        longevity.
                      </p>
                    </div>
                  )}
                  ...
                  {age && parseInt(age) <= 18 && parseInt(age) > 0 && (
                    <div className="mt-5 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/50">
                      <p className="text-xs text-blue-800 dark:text-blue-300">
                        ℹ️ BMI for children and teens should be interpreted
                        using age and gender-specific percentiles. Consult your
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-5 border border-gray-100 dark:border-gray-700">
                ...
                <div className="text-gray-600 dark:text-gray-400 text-sm space-y-2">
                  ...
                  <p>
                    ...
                    have different body fat distribution patterns and muscle
                    mass percentages. Women naturally have higher body fat
                    percentages than men at the same BMI.
                  </p>
                </div>
              </div>

              {/* General Wellness Tips */}
              <div className="bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/30 dark:to-blue-900/30 rounded-xl p-5 border border-teal-100 dark:border-teal-800/50">
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-2 mb-3">
                  <svg
                    className="w-5 h-5 text-teal-500 dark:text-teal-400"
                    fill="none"
