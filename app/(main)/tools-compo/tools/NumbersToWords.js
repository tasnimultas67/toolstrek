    ...
    <ToolPageShell widthClassName="max-w-6xl pt-24 pb-10">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-neutral-700">
            <h2 className="text-xl font-semibold mb-4 text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-neutral-700 pb-2">
              Input Settings
            </h2>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white dark:bg-neutral-800 text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500"
                />
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                  ✓ Supports pasting from Excel, Google Sheets, and other
                  sources (automatically removes commas and spaces)
                </p>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white dark:bg-neutral-800 text-gray-800 dark:text-gray-200"
                >
              ...
              <div className="border border-gray-200 dark:border-neutral-700 rounded-lg overflow-hidden">
                <button
                  ...
                  className="w-full px-4 py-3 bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-700 transition-colors flex justify-between items-center text-left font-medium text-gray-700 dark:text-gray-300"
                >
                  <span>⚙️ Advanced Options</span>
                  <svg
                    className={`w-5 h-5 transform transition-transform text-gray-700 dark:text-gray-300 ${state.isAdvancedOpen ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                {state.isAdvancedOpen && (
                  <div className="p-4 bg-white dark:bg-neutral-900 space-y-4 animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        When set to 2: First result without hyphen, second
                        result with hyphen
                      </p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-neutral-800 rounded-lg border border-gray-200 dark:border-neutral-700">
                      <div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  onClick={handleReset}
                  className="flex-1 bg-gray-400 dark:bg-neutral-600 text-white py-2 px-4 rounded-lg hover:bg-gray-500 dark:hover:bg-neutral-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 transition-all font-semibold"
                >
                  Reset
                </button>
              </div>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-neutral-700 flex flex-col justify-start h-fit md:sticky top-20">
            <h2 className="text-xl font-semibold mb-4 text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-neutral-700 pb-2">
              Converted Results
            </h2>
              ...
              state.outputWords[0] !== "Number too large (max 999,999,999)" ? (
                <div className="w-full space-y-4">
                  {state.outputWords.map((result, index) => (
                    <div
                      key={index}
                      className="bg-blue-700 dark:bg-blue-800 rounded-lg p-4 border border-blue-800 dark:border-blue-700 relative group"
                    >
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <button
                          ...
                          className="text-white transition-colors bg-blue-800 dark:bg-blue-700 p-1 rounded-full cursor-pointer hover:bg-blue-900 dark:hover:bg-blue-600"
                  ...
                  {/* Additional Info */}
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800/30 mt-4">
                ...
                <div className="text-center text-gray-400 dark:text-gray-500 py-8">
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    Example: 2345.78 → Two Thousand Three Hundred Forty-Five
                    Taka And Seventy-Eight Paisa Only
                  </p>
                </div>
              )}
            </div>
        ...
        {/* Footer Note */}
        <div className="text-center mt-6 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-neutral-700 pt-4">
          <p>
            🇧🇩 Supports Bangladeshi Taka (BDT) with Crore and Lac numbering
            system
          </p>
