    ...
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white pt-28 md:pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="w-11/12 mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center lg:text-left">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 mb-4 text-xs font-semibold tracking-wider text-amber-600 uppercase bg-amber-50 border border-amber-200 rounded-full">
        ...
        {favorites.length > 0 ? (
          ...
          >
            ...
            <div className="absolute -top-12 -left-12 w-36 h-36 bg-amber-100/40 rounded-full blur-2xl pointer-events-none" />
            <div className="absolute -bottom-12 -right-12 w-36 h-36 bg-brandColor/5 rounded-full blur-2xl pointer-events-none" />

            <div className="relative z-10 flex flex-col items-center">
              <div className="mb-6 inline-flex items-center justify-center size-16 rounded-2xl bg-amber-50 border border-amber-100 text-amber-500 shadow-sm animate-pulse">
