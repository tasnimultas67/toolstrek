...
export default function RecentClient() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white pt-28 md:pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="w-11/12 mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-brandColor transition-colors duration-200"
          >
        ...
        <div className="mb-12 text-center lg:text-left flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 mb-4 text-xs font-semibold tracking-wider text-indigo-600 uppercase bg-indigo-50 border border-indigo-200 rounded-full">
          ...
          {recentTools.length > 0 && (
            <div className="flex justify-center shrink-0">
              <Button
                ...
                className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700 hover:border-red-300 transition-all duration-200 flex items-center gap-2 cursor-pointer shadow-sm rounded-xl px-5 py-6"
              >
        ...
        {recentTools.length > 0 ? (
          ...
          <motion.div
            ...
            className="max-w-md mx-auto text-center py-16 px-6 bg-white/80 backdrop-blur-md border border-gray-100 rounded-3xl shadow-xl mt-12 relative overflow-hidden"
          >
            {/* Background glows inside empty state card */}
            <div className="absolute -top-12 -left-12 w-36 h-36 bg-indigo-50 rounded-full blur-2xl pointer-events-none" />
            <div className="absolute -bottom-12 -right-12 w-36 h-36 bg-brandColor/5 rounded-full blur-2xl pointer-events-none" />

            <div className="relative z-10 flex flex-col items-center">
              <div className="mb-6 inline-flex items-center justify-center size-16 rounded-2xl bg-indigo-50 border border-indigo-100 text-indigo-500 shadow-sm">
      ...
      <Dialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
        <DialogContent className="sm:max-w-md border-gray-100 rounded-2xl bg-white p-6 shadow-xl z-50">
          <DialogHeader className="space-y-3 flex flex-col items-center">
            <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-red-50 text-red-600 border border-red-100">
              <Trash2 className="size-6" />
            </div>
            <DialogTitle className="text-xl font-bold text-center text-gray-900">
              Clear History?
            </DialogTitle>
            <DialogDescription className="text-center text-gray-500 leading-relaxed">
          ...
          <DialogFooter className="mt-4 flex flex-col-reverse sm:flex-row justify-end gap-2">
            <DialogClose asChild>
              <Button
                type="button"
                variant="outline"
                className="w-full sm:w-auto border-gray-200 hover:bg-gray-50 text-gray-700 cursor-pointer rounded-xl px-5 py-2.5"
              >
                Cancel
              </Button>
            </DialogClose>
