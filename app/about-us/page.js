              ...
              <div className="space-y-10">
                ...
                <AnimatedText delay={0.2}>
                  <p className="text-sm md:w-7/12">
                    ...
                    efficiency. Our mission is to provide intuitive,
                    high-quality online tools that streamline everyday tasks,
                    making life easier for developers, professionals, and casual
                    users alike.
                  </p>
                </AnimatedText>
                ...
                <div className="space-y-3 text-sm text-center">
                  <AnimatedText delay={0.1}>
                    <p>
                      ...
                      Md. Tasnimul Haque, a passionate web developer and
                      branding expert. With a strong foundation in Next.js,
                      WordPress plugin customization, and user experience
                      design, Tasnimul has meticulously crafted ToolsTrek to
                      provide practical and efficient solutions for users
                      seeking powerful online tools.
                    </p>
                  </AnimatedText>

                  <AnimatedText delay={0.2}>
                    <p>
                      Tasnimul&lsquo;s journey in web development has been
                      driven by a commitment to clarity, functionality, and
                      innovation. From configuring vendor workflows to refining
                      website content for professionalism, every aspect of
                      ToolsTrek reflects his methodical approach and attention
                      to detail.
                    </p>
                  </AnimatedText>
                  ...
                  <AnimatedText delay={0.3}>
                    <p>
                      Beyond ToolsTrek, Tasnimul actively engages in freelance
                      web development and branding projects, bringing creative
                      and structured solutions to businesses and individuals.
                    </p>
                  </AnimatedText>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
                ...
                >
                  <p className="text-sm w-full md:w-10/12">
                    ...
                    practical innovation. Every tool, feature, and enhancement
                    is designed with the user in mind, ensuring a smooth and
