      ...
      <div className="relative isolate px-6 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-brandColor/40 to-emerald-500/40 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </motion.div>
