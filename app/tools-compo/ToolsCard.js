  ...
  return (
    <Link href={link} className="group relative">
      <motion.div
        ...
        className="h-full relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-100 p-5 transition-all duration-300 group-hover:bg-white group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] group-hover:-translate-y-1 hover:border-brandColor/40"
      >
